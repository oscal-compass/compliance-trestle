...
def test_profile_to_osco_execute_disable_1_0_0(tmp_path):
    """Test execute call."""
    config = configparser.ConfigParser()
    config_path = pathlib.Path('tests/data/tasks/profile-to-osco/profile-to-osco-disable-1.0.0.config')
    config.read(config_path)
    _test_profile_to_osco_execute_common(tmp_path, config)


def test_profile_to_osco_execute_disable_0_2_0(tmp_path):
    """Test execute call."""
    config = configparser.ConfigParser()
    config_path = pathlib.Path('tests/data/tasks/profile-to-osco/profile-to-osco-disable-0.2.0.config')
    config.read(config_path)
    _test_profile_to_osco_execute_common(tmp_path, config)


def test_profile_to_osco_execute_disable_0_1_59(tmp_path):
    """Test execute call."""
    config = configparser.ConfigParser()
    config_path = pathlib.Path('tests/data/tasks/profile-to-osco/profile-to-osco-disable-0.1.59.config')
    config.read(config_path)
    _test_profile_to_osco_execute_common(tmp_path, config)


def test_profile_to_osco_execute_disable_0_1_58(tmp_path):
    """Test execute call."""
    config = configparser.ConfigParser()
    config_path = pathlib.Path('tests/data/tasks/profile-to-osco/profile-to-osco-disable-0.1.58.config')
    config.read(config_path)
    _test_profile_to_osco_execute_common(tmp_path, config)


def test_profile_to_osco_execute_disable_osco_0_1_39(tmp_path):
    """Test execute call."""
    config = configparser.ConfigParser()
    config_path = pathlib.Path('tests/data/tasks/profile-to-osco/profile-to-osco-disable-osco-0.1.39.config')
    config.read(config_path)
    _test_profile_to_osco_execute_common(tmp_path, config)
