...
def test_subsequent_split_model_plans(
    ...
    root_wrapper_alias = trestle.common.str_utils.classname_to_alias(stripped_root.__class__.__name__, AliasMode.JSON)
...
def test_split_multi_level_dict_plans(
    ...
    for index, comp_obj in enumerate(components):
        ...
        model_type = trestle.common.str_utils.classname_to_alias(type(comp_obj).__name__, AliasMode.JSON)
        ...
        for i, component_ctrl_impl in enumerate(component_ctrl_impls):
            model_type = trestle.common.str_utils.classname_to_alias(type(component_ctrl_impl).__name__, AliasMode.JSON)
