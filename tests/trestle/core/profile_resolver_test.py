...
def test_remote_profile_relative_cat(tmp_trestle_dir: pathlib.Path) -> None:
    ...
    profile_path = 'https://raw.githubusercontent.com/usnistgov/oscal-content/refs/heads/main/nist.gov/SP800-53/rev5/json/NIST_SP-800-53_rev5_LOW-baseline_profile.json'  # noqa E501
