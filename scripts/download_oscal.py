#!/usr/bin/env python3
"""
Download OSCAL release schemas.

This script downloads OSCAL JSON schemas from the official
...
Examples:
    ...
    python3 scripts/download_oscal.py --version 1.2.2    # Download v1.2.2
...
def download_oscal(version, output_dir=None):
    ...
    try:
        ...
        # Update README.md with the downloaded version
        readme_path = schemas_dir / 'README.md'
        readme_content = f"""#### NIST OSCAL Release

See [OSCAL v{version}](https://github.com/usnistgov/OSCAL/releases/tag/v{version})
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="""Download OSCAL release schemas.
