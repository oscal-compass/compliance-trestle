...
echo datamodel-codegen --input-file-type jsonschema --input 3rd-party-schema-documents/IBM_target_schema.json --base-class trestle.core.base_model.OscalBaseModel --output $OUTPUT_DIR/target:s/-/_/.py
datamodel-codegen --input-file-type jsonschema --input 3rd-party-schema-documents/IBM_target_schema.json --base-class trestle.core.base_model.OscalBaseModel --output $OUTPUT_DIR/target:s/-/_/.py
