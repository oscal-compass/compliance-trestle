...
class CatalogGenerate(AuthorCommonCommand):
    ...
    def _run(self, args: argparse.Namespace) -> int:
        ...
        return self.generate_markdown(trestle_root, catalog_path, markdown_path, yaml_header, args.header_merge)
    ...
    def generate_markdown(
        ...
        try:
            ...
            catalog_interface.write_catalog_as_markdown(
                markdown_path, yaml_header, None, False, header_merge=header_merge
            )
