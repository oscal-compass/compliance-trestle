...
class GenericByComponent(TrestleBaseModel):
    ...
    # only in SSP
    component_uuid: Annotated[str, StringConstraints(pattern=UUID_REGEX)] = Field(
        ...,
        alias='component_uuid',
        description='A machine-oriented identifier reference to the component that is implementing a given control.',
...
class GenericStatement(TrestleBaseModel):
    ...
    statement_id: Annotated[str, StringConstraints(pattern=ID_REGEX)] = Field(
        ...,
        alias='statement_id',
