...
class Mapping(OscalBaseModel):
    ...
    source_resource: common.MappingResourceReference = Field(
        ..., alias='source-resource'
    )
    target_resource: common.MappingResourceReference = Field(
...
class MappingCollection(OscalBaseModel):
    ...
    mappings: Union[
        OscalMappingOscalMappingMapping, List[Mapping]
    ]
