...
class OscalCatalogRemarks(OscalBaseModel):
    __root__: str = Field(
        ..., description='Additional commentary on the containing object.'
    )


class OscalCatalogProperty(OscalBaseModel):
    name: str = Field(
        ...,
...
class OscalCatalogPartyUuid(OscalBaseModel):
    __root__: constr(
        regex=r'^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-4[0-9A-Fa-f]{3}-[89ABab][0-9A-Fa-f]{3}-[0-9A-Fa-f]{12}$'
    ) = Field(..., description='References a party defined in metadata.')


class OscalCatalogParameterValue(OscalBaseModel):
    __root__: str = Field(..., description='A parameter value or set of values.')


class OscalCatalogParameterSelection(OscalBaseModel):
    class Config:
        extra = Extra.allow
...
class OscalCatalogParameterGuideline(OscalBaseModel):
    class Config:
        extra = Extra.allow
...
class OscalCatalogOscalMetadataVersion(OscalBaseModel):
    __root__: str = Field(
        ...,
...
class OscalCatalogOscalMetadataTelephoneNumber(OscalBaseModel):
...
class OscalCatalogOscalMetadataPublished(OscalBaseModel):
...
class OscalCatalogOscalMetadataOscalVersion(OscalBaseModel):
    __root__: str = Field(
        ..., description='The OSCAL model version the document was authored against.'
    )


class OscalCatalogOscalMetadataLastModified(OscalBaseModel):
    __root__: datetime = Field(
        ...,
...
class OscalCatalogOscalMetadataEmailAddress(OscalBaseModel):
    __root__: EmailStr = Field(
        ..., description='An email address as defined by RFC 5322 Section 3.4.1.'
    )


class OscalCatalogOscalMetadataDocumentId(OscalBaseModel):
...
class OscalCatalogOscalMetadataAddress(OscalBaseModel):
    type: Optional[str] = Field(
...
class OscalCatalogOscalMetadataAddrLine(OscalBaseModel):
    __root__: str = Field(..., description='A single line of an address.')


class OscalCatalogLocationUuid(OscalBaseModel):
    __root__: constr(
        regex=r'^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-4[0-9A-Fa-f]{3}-[89ABab][0-9A-Fa-f]{3}-[0-9A-Fa-f]{12}$'
    ) = Field(..., description='References a location defined in metadata.')


class OscalCatalogLink(OscalBaseModel):
    href: str = Field(
        ...,
...
class OscalCatalogHash(OscalBaseModel):
    algorithm: str = Field(
...
class OscalCatalogCatalog(OscalBaseModel):
    uuid: constr(
        regex=r'^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-4[0-9A-Fa-f]{3}-[89ABab][0-9A-Fa-f]{3}-[0-9A-Fa-f]{12}$'
    ) = Field(
        ...,
...
class OscalCatalogControl(OscalBaseModel):
    class Config:
        extra = Extra.allow
    ...
    controls: Optional[List[Control]] = Field(None, min_items=1)
class OscalCatalogGroup(OscalBaseModel):
...
class OscalCatalogLocation(OscalBaseModel):
    uuid: constr(
        regex=r'^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-4[0-9A-Fa-f]{3}-[89ABab][0-9A-Fa-f]{3}-[0-9A-Fa-f]{12}$'
    ) = Field(
        ...,
...
class OscalCatalogMetadata(OscalBaseModel):
    title: str = Field(
        ...,
...
class OscalCatalogOscalMetadataRevision(OscalBaseModel):
    title: Optional[str] = Field(
        None,
...
class OscalCatalogParameter(OscalBaseModel):
    class Config:
        extra = Extra.allow
...
class OscalCatalogPart(OscalBaseModel):
    class Config:
        extra = Extra.allow
...
class OscalCatalogParty(OscalBaseModel):
    uuid: constr(
        regex=r'^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-4[0-9A-Fa-f]{3}-[89ABab][0-9A-Fa-f]{3}-[0-9A-Fa-f]{12}$'
    ) = Field(
        ...,
...
class OscalCatalogResponsibleParty(OscalBaseModel):
...
class OscalCatalogRole(OscalBaseModel):
    id: str = Field(
        ...,
...
class OscalCatalogParameterConstraint(OscalBaseModel):
    description: Optional[str] = Field(
        None,
...
class OscalCatalogBackMatter(OscalBaseModel):
