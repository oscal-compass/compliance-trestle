...
class OscalCatalogControl(OscalBaseModel):
    ...
    controls: Optional[List[OscalCatalogControl]] = None
...
class OscalCatalogGroup(OscalBaseModel):
    ...
    links: Optional[List[OscalMetadataLink]] = Field(None, min_items=1)
    parts: Optional[List[CommonPart]] = Field(None, min_items=1)
    groups: Optional[List[OscalCatalogGroup]] = None
    controls: Optional[List[OscalCatalogControl]] = Field(None, min_items=1)
...
class OscalCatalogCatalog(OscalBaseModel):
    ...
    params: Optional[List[CommonParameter]] = Field(None, min_items=1)
    controls: Optional[List[OscalCatalogControl]] = Field(None, min_items=1)
    groups: Optional[List[OscalCatalogGroup]] = Field(None, min_items=1)
    back_matter: Optional[OscalMetadataBackMatter] = Field(None, alias='back-matter')


class Model(OscalBaseModel):
    catalog: OscalCatalogCatalog


CommonPart.update_forward_refs()
OscalCatalogControl.update_forward_refs()
OscalCatalogGroup.update_forward_refs()
