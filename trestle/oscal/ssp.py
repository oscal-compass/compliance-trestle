...
#   timestamp: 2020-09-17T04:59:33+00:00
...
class InformationTypeIds(OscalBaseModel):
    pass
...
class InventoryItems(OscalBaseModel):
    pass
...
class ImplementedComponents(OscalBaseModel):
    pass
...
class Statement(OscalBaseModel):
    ...
    by_components: Optional[Dict[str, ByComponents]] = Field(
...
class AuthorizationBoundary(OscalBaseModel):
    ...
    annotations: Optional[List[Annotation]] = None
    links: Optional[List[Link]] = None
    diagrams: Optional[Dict[str, Diagrams]] = None
    remarks: Optional[Remarks] = None
...
class SystemImplementation(OscalBaseModel):
    ...
    components: Optional[Dict[str, Components]] = None
...
class InventoryItem(OscalBaseModel):
    ...
    implemented_components: Optional[Dict[str, ImplementedComponents]] = Field(
...
class ImplementedRequirement(OscalBaseModel):
    ...
    statements: Optional[Dict[str, Statements]] = None
    remarks: Optional[Remarks] = None
...
class InformationType(OscalBaseModel):
    ...
    title: Title
    description: Description
    information_type_ids: Optional[Dict[str, InformationTypeIds]] = Field(
