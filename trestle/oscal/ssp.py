...
class AdjustmentJustification(RootModel[common.MarkupMultilineDatatype]):
...
class Base(RootModel[common.StringDatatype]):
    root: constr(pattern=r'^\S(.*\S)?$') = Field(..., description='The prescribed base (Confidentiality, Integrity, or Availability) security impact level.', title='Base Level (Confidentiality, Integrity, or Availability)')


class DateDatatype(RootModel[constr(pattern=r'^(((2000|2400|2800|(19|2[0-9](0[48]|[2468][048]|[13579][26])))-02-29)|(((19|2[0-9])[0-9]{2})-02-(0[1-9]|1[0-9]|2[0-8]))|(((19|2[0-9])[0-9]{2})-(0[13578]|10|12)-(0[1-9]|[12][0-9]|3[01]))|(((19|2[0-9])[0-9]{2})-(0[469]|11)-(0[1-9]|[12][0-9]|30)))(Z|(-((0[0-9]|1[0-2]):00|0[39]:30)|\+((0[0-9]|1[0-4]):00|(0[34569]|10):30|(0[58]|12):45)))?$')]):
    root: constr(pattern=r'^(((2000|2400|2800|(19|2[0-9](0[48]|[2468][048]|[13579][26])))-02-29)|(((19|2[0-9])[0-9]{2})-02-(0[1-9]|1[0-9]|2[0-8]))|(((19|2[0-9])[0-9]{2})-(0[13578]|10|12)-(0[1-9]|[12][0-9]|3[01]))|(((19|2[0-9])[0-9]{2})-(0[469]|11)-(0[1-9]|[12][0-9]|30)))(Z|(-((0[0-9]|1[0-2]):00|0[39]:30)|\+((0[0-9]|1[0-4]):00|(0[34569]|10):30|(0[58]|12):45)))?$') = Field(..., description='A string representing a 24-hour period with an optional timezone.')
...
class Diagram(OscalBaseModel):
    ...
    description: str | None = Field(None, description='A summary of the diagram.', title='Diagram Description')
    props: list[common.Property] | None = Field(None, min_length=1)
    links: list[common.Link] | None = Field(None, min_length=1)
    caption: constr(pattern=r'^[^\n]+$') | None = Field(None, description='A brief caption to annotate the diagram.', title='Caption')
...
class Inherited(OscalBaseModel):
    ...
    provided_uuid: constr(pattern=r'^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[45][0-9A-Fa-f]{3}-[89ABab][0-9A-Fa-f]{3}-[0-9A-Fa-f]{12}$') | None = Field(None, alias='provided-uuid', description='A machine-oriented identifier reference to an inherited control implementation that a leveraging system is inheriting from a leveraged system.', title='Provided UUID')
...
class Satisfied(OscalBaseModel):
    ...
    responsibility_uuid: constr(pattern=r'^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[45][0-9A-Fa-f]{3}-[89ABab][0-9A-Fa-f]{3}-[0-9A-Fa-f]{12}$') | None = Field(None, alias='responsibility-uuid', description='A machine-oriented identifier reference to a control implementation that satisfies a responsibility imposed by a leveraged system.', title='Responsibility UUID')
...
class SecurityImpactLevel(OscalBaseModel):
    ...
    security_objective_confidentiality: constr(pattern=r'^\S(.*\S)?$') = Field(..., alias='security-objective-confidentiality', description='A target-level of confidentiality for the system, based on the sensitivity of information within the system.', title='Security Objective: Confidentiality')
    security_objective_integrity: constr(pattern=r'^\S(.*\S)?$') = Field(..., alias='security-objective-integrity', description='A target-level of integrity for the system, based on the sensitivity of information within the system.', title='Security Objective: Integrity')
    security_objective_availability: constr(pattern=r'^\S(.*\S)?$') = Field(..., alias='security-objective-availability', description='A target-level of availability for the system, based on the sensitivity of information within the system.', title='Security Objective: Availability')


class Selected(RootModel[common.StringDatatype]):
    root: constr(pattern=r'^\S(.*\S)?$') = Field(..., description='The selected (Confidentiality, Integrity, or Availability) security impact level.', title='Selected Level (Confidentiality, Integrity, or Availability)')
...
class AuthorizationBoundary(OscalBaseModel):
    ...
    props: list[common.Property] | None = Field(None, min_length=1)
    links: list[common.Link] | None = Field(None, min_length=1)
    diagrams: list[Diagram] | None = Field(None, min_length=1)
    remarks: str | None = None
...
class Categorization(OscalBaseModel):
    ...
    system: AnyUrl | System = Field(..., description='Specifies the information type identification system used.', title='Information Type Identification System')
    information_type_ids: list[constr(pattern=r'^\S(.*\S)?$')] | None = Field(None, alias='information-type-ids', min_length=1)
...
class Export(OscalBaseModel):
    ...
    description: str | None = Field(None, description='An implementation statement that describes the aspects of the control or control statement implementation that can be available to another system leveraging this system.', title='Control Implementation Export Description')
    props: list[common.Property] | None = Field(None, min_length=1)
    links: list[common.Link] | None = Field(None, min_length=1)
    provided: list[Provided] | None = Field(None, min_length=1)
    responsibilities: list[Responsibility] | None = Field(None, min_length=1)
    remarks: str | None = None
...
class ByComponent(OscalBaseModel):
    ...
    component_uuid: constr(pattern=r'^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[45][0-9A-Fa-f]{3}-[89ABab][0-9A-Fa-f]{3}-[0-9A-Fa-f]{12}$') = Field(..., alias='component-uuid', description='A machine-oriented identifier reference to the component that is implementing a given control.', title='Component Universally Unique Identifier Reference')
    uuid: constr(pattern=r'^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[45][0-9A-Fa-f]{3}-[89ABab][0-9A-Fa-f]{3}-[0-9A-Fa-f]{12}$') = Field(
        ...,
    ...
    implementation_status: common.ImplementationStatus | None = Field(None, alias='implementation-status')
    export: Export | None = Field(None, description='Identifies content intended for external consumption, such as with leveraged organizations.', title='Export')
    inherited: list[Inherited] | None = Field(None, min_length=1)
    satisfied: list[Satisfied] | None = Field(None, min_length=1)
    responsible_roles: list[common.ResponsibleRole] | None = Field(None, alias='responsible-roles', min_length=1)
    remarks: str | None = None
...
class Impact(OscalBaseModel):
    ...
    adjustment_justification: AdjustmentJustification | None = Field(None, alias='adjustment-justification')
...
class InformationType(OscalBaseModel):
    ...
    title: constr(pattern=r'^[^\n]+$') = Field(..., description='A human readable name for the information type. This title should be meaningful within the context of the system.', title='title field')
    ...
    categorizations: list[Categorization] | None = Field(None, min_length=1)
    props: list[common.Property] | None = Field(None, min_length=1)
    links: list[common.Link] | None = Field(None, min_length=1)
    confidentiality_impact: Impact | None = Field(None, alias='confidentiality-impact')
    integrity_impact: Impact | None = Field(None, alias='integrity-impact')
    availability_impact: Impact | None = Field(None, alias='availability-impact')
...
class LeveragedAuthorization(OscalBaseModel):
    ...
    title: constr(pattern=r'^[^\n]+$') = Field(..., description='A human readable name for the leveraged authorization in the context of the system.', title='title field')
    props: list[common.Property] | None = Field(None, min_length=1)
    links: list[common.Link] | None = Field(None, min_length=1)
    party_uuid: constr(pattern=r'^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[45][0-9A-Fa-f]{3}-[89ABab][0-9A-Fa-f]{3}-[0-9A-Fa-f]{12}$') = Field(..., alias='party-uuid', description='A machine-oriented identifier reference to the party that manages the leveraged system.', title='party-uuid field')
...
class Statement(OscalBaseModel):
    ...
    links: list[common.Link] | None = Field(None, min_length=1)
    responsible_roles: list[common.ResponsibleRole] | None = Field(None, alias='responsible-roles', min_length=1)
    by_components: list[ByComponent] | None = Field(None, alias='by-components', min_length=1)
    remarks: str | None = None
...
class SystemImplementation(OscalBaseModel):
    ...
    props: list[common.Property] | None = Field(None, min_length=1)
    links: list[common.Link] | None = Field(None, min_length=1)
    leveraged_authorizations: list[LeveragedAuthorization] | None = Field(None, alias='leveraged-authorizations', min_length=1)
...
class SystemCharacteristics(OscalBaseModel):
    ...
    system_name: constr(pattern=r'^\S(.*\S)?$') = Field(..., alias='system-name', description='The full name of the system.', title='System Name - Full')
    system_name_short: constr(pattern=r'^\S(.*\S)?$') | None = Field(None, alias='system-name-short', description='A short name for the system, such as an acronym, that is suitable for display in a data table or summary list.', title='System Name - Short')
    description: str = Field(..., description='A summary of the system.', title='System Description')
    props: list[common.Property] | None = Field(None, min_length=1)
    links: list[common.Link] | None = Field(None, min_length=1)
    date_authorized: DateAuthorized | None = Field(None, alias='date-authorized')
    security_sensitivity_level: constr(pattern=r'^\S(.*\S)?$') | None = Field(None, alias='security-sensitivity-level', description='The overall information system sensitivity categorization, such as defined by FIPS-199.', title='Security Sensitivity Level')
    system_information: SystemInformation = Field(..., alias='system-information')
    security_impact_level: SecurityImpactLevel | None = Field(None, alias='security-impact-level')
    status: Status1
    authorization_boundary: AuthorizationBoundary = Field(..., alias='authorization-boundary')
    network_architecture: NetworkArchitecture | None = Field(None, alias='network-architecture')
    data_flow: DataFlow | None = Field(None, alias='data-flow')
