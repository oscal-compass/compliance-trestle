...
class OscalComponentDefinitionOscalMetadataVersion(OscalBaseModel):
    __root__: str = Field(
        ...,
...
class OscalComponentDefinitionOscalMetadataTelephoneNumber(OscalBaseModel):
...
class OscalComponentDefinitionOscalMetadataPublished(OscalBaseModel):
...
class OscalComponentDefinitionOscalMetadataOscalVersion(OscalBaseModel):
    __root__: str = Field(
        ..., description='The OSCAL model version the document was authored against.'
    )


class OscalComponentDefinitionOscalMetadataLastModified(OscalBaseModel):
    __root__: datetime = Field(
        ...,
...
class OscalComponentDefinitionOscalMetadataEmailAddress(OscalBaseModel):
    __root__: EmailStr = Field(
        ..., description='An email address as defined by RFC 5322 Section 3.4.1.'
    )


class OscalComponentDefinitionOscalMetadataDocumentId(OscalBaseModel):
...
class OscalComponentDefinitionOscalMetadataAddress(OscalBaseModel):
    type: Optional[str] = Field(
...
class OscalComponentDefinitionOscalMetadataAddrLine(OscalBaseModel):
...
class OscalComponentDefinitionOscalMetadataRevision(OscalBaseModel):
    title: Optional[str] = Field(
        None,
