...
#   filename:  custom_target_schema.json
#   timestamp: 2020-09-01T05:43:20+00:00
...
class Statement(OscalBaseModel):
    ...
    responsible_roles: Optional[Dict[str, Any]] = Field(None, alias='responsible-roles')
    remarks: Optional[Remarks] = None
...
class ImplementedRequirement(OscalBaseModel):
    ...
    links: Optional[List[Link]] = None
    responsible_roles: Optional[Dict[str, Any]] = Field(None, alias='responsible-roles')
    set_parameters: Optional[Dict[str, Any]] = Field(None, alias='set-parameters')
...
class TargetDefinition(OscalBaseModel):
    ...
    import_target_definitions: Optional[List[ImportTargetDefinition]] = Field(
        None, alias='import-target-definitions'
    )
...
class Target(OscalBaseModel):
    ...
    target_control_implementations: Optional[List[TargetControlImplementation]] = Field(
        None, alias='target-control-implementations'
    )
    remarks: Optional[Remarks] = None
...
class Capability(OscalBaseModel):
    ...
    annotations: Optional[List[Annotation]] = None
    links: Optional[List[Link]] = None
    incorporates_targets: Optional[Dict[str, Any]] = Field(
