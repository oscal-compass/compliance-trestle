...
class ParameterValue(OscalBaseModel):
    __root__: str = Field(..., description='A parameter value or set of values.', title='Parameter Value')
...
class Address(OscalBaseModel):
    type: Optional[str] = Field(None, description='Indicates the type of address.', title='Address Type')
...
class TelephoneNumber(OscalBaseModel):
    type: Optional[str] = Field(None, description='Indicates the type of phone number.', title='type flag')
    number: str
...
class Hash(OscalBaseModel):
    algorithm: str = Field(..., description='Method by which a hash is derived', title='Hash algorithm')
    value: str
...
class ImportTargetDefinition(OscalBaseModel):
    href: str = Field(
        ...,
        description=
        'A link to a resource that defines a set of targets and/or capabilities to import into this collection.',
...
class ResponsibleRole(OscalBaseModel):
    ...
    annotations: Optional[List[Annotation]] = Field(None, min_items=1)
    links: Optional[List[Link]] = Field(None, min_items=1)
    party_uuids: Optional[List[PartyUuid]] = Field(None, alias='party-uuids', min_items=1)
    remarks: Optional[Remarks] = None
...
class Protocol(OscalBaseModel):
    ...
    port_ranges: Optional[List[PortRange]] = Field(None, alias='port-ranges', min_items=1)


class AuthorizedPrivilege(OscalBaseModel):
    title: str = Field(..., description='A human readable name for the privilege.', title='title field')
    description: Optional[str] = Field(
        None,
        description="A summary of the privilege's purpose within the system.",
        title='Privilege Description',
    )
    functions_performed: List[FunctionPerformed] = Field(..., alias='functions-performed', min_items=1)
...
class Location(OscalBaseModel):
    ...
    address: Address = Field(..., description='A postal address for the location.', title='Address')
    email_addresses: Optional[List[EmailAddress]] = Field(None, alias='email-addresses', min_items=1)
    telephone_numbers: Optional[List[TelephoneNumber]] = Field(None, alias='telephone-numbers', min_items=1)
...
class Party(OscalBaseModel):
    ...
    external_ids: Optional[List[ExternalId]] = Field(None, alias='external-ids', min_items=1)
    props: Optional[List[Property]] = Field(None, min_items=1)
    annotations: Optional[List[Annotation]] = Field(None, min_items=1)
    links: Optional[List[Link]] = Field(None, min_items=1)
    email_addresses: Optional[List[EmailAddress1]] = Field(None, alias='email-addresses', min_items=1)
    telephone_numbers: Optional[List[TelephoneNumber1]] = Field(None, alias='telephone-numbers', min_items=1)
    addresses: Optional[List[Address1]] = Field(None, min_items=1)
    location_uuids: Optional[List[LocationUuid]] = Field(None, alias='location-uuids', min_items=1)
...
class Resource(OscalBaseModel):
    ...
    props: Optional[List[Property]] = Field(None, min_items=1)
    annotations: Optional[List[Annotation]] = Field(None, min_items=1)
    document_ids: Optional[List[DocumentId1]] = Field(None, alias='document-ids', min_items=1)
...
class SystemUser(OscalBaseModel):
    ...
    authorized_privileges: Optional[List[AuthorizedPrivilege]] = Field(None, alias='authorized-privileges', min_items=1)
    remarks: Optional[Remarks] = None
...
class ImplementedTarget(OscalBaseModel):
    ...
    annotations: Optional[List[Annotation]] = Field(None, min_items=1)
    links: Optional[List[Link]] = Field(None, min_items=1)
    responsible_parties: Optional[Dict[str, ResponsibleParty]] = Field(None, alias='responsible-parties')
    remarks: Optional[Remarks] = None
...
class InventoryItem(OscalBaseModel):
    ...
    links: Optional[List[Link]] = Field(None, min_items=1)
    responsible_parties: Optional[Dict[str, ResponsibleParty]] = Field(None, alias='responsible-parties')
    implemented_targets: Optional[List[ImplementedTarget]] = Field(None, alias='implemented-targets', min_items=1)
    remarks: Optional[Remarks] = None
...
class Metadata(OscalBaseModel):
    ...
    document_ids: Optional[List[DocumentId]] = Field(None, alias='document-ids', min_items=1)
    props: Optional[List[Property]] = Field(None, min_items=1)
    annotations: Optional[List[Annotation]] = Field(None, min_items=1)
    links: Optional[List[Link]] = Field(None, min_items=1)
...
class TargetControlImplementation(OscalBaseModel):
    ...
    description: str = Field(
        ...,
        description=
        'A description of how the spefied set of controls are implemented for the containing target or capability.',
        title='Control Implementation Description',
    )
    props: Optional[List[Property]] = Field(None, min_items=1)
    params: Optional[List[Parameter]] = Field(None, min_items=1)
    annotations: Optional[List[Annotation]] = Field(None, min_items=1)
    links: Optional[List[Link]] = Field(None, min_items=1)
    implemented_requirements: List[ImplementedRequirement] = Field(..., alias='implemented-requirements', min_items=1)
...
class DefinedTarget(OscalBaseModel):
    ...
    title: str = Field(..., description='A human readable name for the target.', title='Target Title')
    description: str = Field(
        ...,
        description='A description of the target, including information about its function.',
        title='Target Description',
...
class Capability(OscalBaseModel):
    ...
    annotations: Optional[List[Annotation]] = Field(None, min_items=1)
    links: Optional[List[Link]] = Field(None, min_items=1)
    incorporates_targets: Optional[Dict[str, IncorporatesTarget]] = Field(None, alias='incorporates-targets')
    target_control_implementations: Optional[List[TargetControlImplementation]] = Field(
        None, alias='target-control-implementations', min_items=1
    )
    remarks: Optional[Remarks] = None
...
class TargetDefinition(OscalBaseModel):
    uuid: constr(
        ...
        ...,
        description=
        'A globally unique identifier for this target definition instance. This UUID should be changed when this document is revised.',
