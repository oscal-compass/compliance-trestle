...
#   timestamp: 2020-09-17T04:59:34+00:00
...
class ImplementedRequirement(OscalBaseModel):
    ...
    set_parameters: Optional[Dict[str, SetParameters]] = Field(
...
class Capability(OscalBaseModel):
    ...
    annotations: Optional[List[Annotation]] = None
    links: Optional[List[Link]] = None
    incorporates_targets: Optional[Dict[str, IncorporatesTargets]] = Field(
