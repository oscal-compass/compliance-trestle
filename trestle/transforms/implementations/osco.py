...
"""Facilitate OSCO <--> OSCAL transformation."""
...
class OscoTransformer(ResultsTransformer):
    ...
    def __init__(self) -> None:
        """Initialize."""
        self._results_factory = OscoOscalResultsFactory(self.get_timestamp())
...
class OscoOscalResultsFactory():
    """Build OSCO OSCAL Results entities."""
