...
import trestle_sdk.oscal as oscal
import trestle_sdk.oscal.assessment_results as ar
...
def test_get_all_sample_models() -> None:
    ...
    for _, name, _ in pkgutil.iter_modules([pkgpath]):
        __import__(f'trestle_sdk.oscal.{name}')
        clsmembers = inspect.getmembers(sys.modules[f'trestle_sdk.oscal.{name}'], inspect.isclass)
