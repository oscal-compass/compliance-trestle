...
@pytest.mark.parametrize(
    ...
    [
        (
            pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/single_tab_bad_metadata_extra_fields_compressed.drawio'),
            True,
            False
        ),
        (
            pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/single_tab_bad_metadata_missing_fields_compressed.drawio'),
            True,
            False
        ), (pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/single_tab_metadata_compressed.drawio'), True, True),
        (pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/single_tab_no_metadata_compressed.drawio'), False, False),
        (pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/single_tab_no_metadata_uncompressed.drawio'), False, False),
        (pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/two_tabs_metadata_compressed.drawio'), True, True),
        (pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/two_tabs_metadata_second_tab_compressed.drawio'), True, False)
    ]
)
...
@pytest.mark.parametrize(
    'bad_file_name',
    [
        (pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/single_tab_no_metadata_uncompressed_mangled.drawio')),
        (pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/not_mxfile.drawio')),
        (pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/single_tab_no_metadata_bad_internal_structure.drawio'))
    ]
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/single_tab_metadata_compressed.drawio'),
            pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/single_tab_metadata_compressed.drawio'),
            True,
            True
        ),
        (
            pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/single_tab_metadata_compressed.drawio'),
            pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/two_tabs_metadata_compressed.drawio'),
            True,
            True
        ),
        (
            pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/single_tab_metadata_compressed.drawio'),
            pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/two_tabs_metadata_second_tab_compressed.drawio'),
            True,
            False
        ),
        (
        ...
        (
            pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/single_tab_metadata_compressed.drawio'),
            pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/two_tabs_metadata_second_tab_bad_md.drawio'),
            False,
            False
        )
    ]
...
def test_restructure_metadata():
    ...
    drawio_file = pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/single_tab_metadata_compressed.drawio')
...
def test_write_metadata_compressed(tmp_path):
    ...
    shutil.copyfile(
        pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/single_tab_metadata_compressed.drawio'), tmp_drawio_file
    )
...
def test_write_metadata_uncompressed(tmp_path):
    ...
    tmp_drawio_file = tmp_path / 'test.drawio'
    shutil.copyfile(
        pathlib.Path('trestle-cli/tests/data/author/0.0.1/drawio/single_tab_metadata_uncompressed.drawio'), tmp_drawio_file
    )
    draw_io = DrawIO(tmp_drawio_file)
