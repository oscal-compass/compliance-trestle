...
from trestle_sdk.oscal.catalog import Catalog, Group
from trestle_sdk.oscal.profile import Modify, Profile, SetParameter
...
def test_import_cmd(tmp_trestle_dir: pathlib.Path, monkeypatch: MonkeyPatch) -> None:
    ...
    profile_data = generators.generate_sample_model(trestle_sdk.oscal.profile.Profile)
    ...
    dup_cat = {
        'catalog': {
            ...
            'metadata': {
                ...
                'version': '0.0.0',
                'oscal-version': trestle_sdk.oscal.OSCAL_VERSION
            },
            'back-matter': {
                'resources': [
                    {
