...
### Profile content seeding

CLI evocation:

> trestle author profile-seed

The `profile-seed` sub-command takes a given parent profile and filters its imported controls based inherited controls from a given SSP.
